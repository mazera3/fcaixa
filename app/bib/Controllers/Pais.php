...
class Pais
{
    ...
    public function listar($PageId = null)
    {
        ...
        $botao = ['cad_pais' => ['menu_controller' => 'cadastrar-pais', 'menu_metodo' => 'cad-pais'],
        ...
        $listarPais = new \App\bib\Models\BibListarPais();
        $this->Dados['listPais'] = $listarPais->listarPais($this->PageId);
        $this->Dados['paginacao'] = $listarPais->getResultadoPg();
