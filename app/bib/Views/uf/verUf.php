...
if (!empty($this->Dados['dados_uf'][0])) {
    extract($this->Dados['dados_uf'][0]);
    ?>
    <div class="content p-1">
        <div class="list-group-item">
            <div class="d-flex">
                <div class="mr-auto p-2">
                    <h2 class="display-4 titulo">Ver Estado</h2>
                </div>
                <div class="p-2">
                    <span class="d-none d-md-block">
                        <?php
                        if ($this->Dados['botao']['list_uf']) {
                            echo "<a href='" . URLADM . "uf/listar' class='btn btn-outline-info btn-sm'>Listar</a> ";
                        }
            ...
            <dl class="row">
                ...
                <dd class="col-sm-9">                    
                    ...
                    if (!empty($logo_imagem)) {
                        echo "<img src='" . URLADM . "app/bib/assets/imagens/uf/" . $uf_id . "/" . $logo_imagem . "' witdh='135' height='90'>";
                    } else {
                        echo "<img src='" . URLADM . "app/bib/assets/imagens/uf/mat.png' witdh='135' height='180'>";
                    }
                    ?>
                </dd>

                <dt class="col-sm-3">ID</dt>
                <dd class="col-sm-9"><?php echo $uf_id; ?></dd>

                <dt class="col-sm-3">Nome do Estado</dt>
                <dd class="col-sm-9"><?php echo $nome . ' - ' . $uf; ?></dd>
