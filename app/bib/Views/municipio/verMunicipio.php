...
if (!empty($this->Dados['dados_mun'][0])) {
    extract($this->Dados['dados_mun'][0]);
    ?>
    <div class="content p-1">
        <div class="list-group-item">
            <div class="d-flex">
                <div class="mr-auto p-2">
                    <h2 class="display-4 titulo">Ver Municipio</h2>
                </div>
                <div class="p-2">
                    <span class="d-none d-md-block">
                        <?php
                        if ($this->Dados['botao']['list_mun']) {
                            echo "<a href='" . URLADM . "municipio/listar' class='btn btn-outline-info btn-sm'>Listar</a> ";
                        }
                    ...
                    <div class="dropdown d-block d-md-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar"> 
                            <?php
                            if ($this->Dados['botao']['list_mun']) {
                                echo "<a class='dropdown-item' href='" . URLADM . "municipio/listar'>Listar</a>";
                            }
                            if ($this->Dados['botao']['edit_mun']) {
            ...
            <dl class="row">
                ...
                <dd class="col-sm-9">                    
                    <?php
                    if (!empty($bandeira)) {
                        echo "<img src='" . URLADM . "app/bib/assets/imagens/municipio/" . $mun_id . "/" . $bandeira . "' witdh='120' height='150'>";
                    } else {
                        echo "<img src='" . URLADM . "app/bib/assets/imagens/municipio/bandeira.png' witdh='120' height='150'>";
                    }
                    ?>
                </dd>

                <dt class="col-sm-3">ID</dt>
                <dd class="col-sm-9"><?php echo $mun_id; ?></dd>
