    ...
    <div class="list-group-item">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover table-bordered table-sm">
                ...
                <tbody>
                    <?php
                    //var_dump($this->Dados['listBr']);
                    foreach ($this->Dados['listBr'] as $br) {
                        extract($br);
                        ?>
                        <tr>
                            <th><?php echo $br_id; ?></th>
                            <td><?php echo $bairro; ?></td>
                            <td><?php echo $municipio; ?></td>
                            <td><?php
                                if (!empty($logo_imagem)) {
                                    echo "<img src='" . URLADM . "app/bib/assets/imagens/bairro/" . $br_id . "/" . $logo_imagem . "' witdh='30' height='30'>";
                                } else {
                                    echo "<img src='" . URLADM . "app/bib/assets/imagens/bairro/logo_imagem.png' witdh='30' height='30'>";
                                }
                                ?></td>
                            <td class="text-center">
                                <span class="d-none d-md-block">
                                    ...
                                    if ($this->Dados['botao']['vis_br']) {
                                        echo "<a href='" . URLADM . "ver-bairro/ver-bairro/$br_id' class='btn btn-outline-primary btn-sm'>Visualizar</a> ";
                                    }
                                ...
                                <div class="dropdown d-block d-md-none">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                                        <?php
                                        if ($this->Dados['botao']['vis_br']) {
                                            echo "<a class='dropdown-item' href='" . URLADM . "ver-bairro/ver-bairro/$br_id'>Visualizar</a>";
                                        }
                                        if ($this->Dados['botao']['edit_br']) {
