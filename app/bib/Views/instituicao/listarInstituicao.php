    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Listar Instituição</h2>
            </div>
            <div class="p-2">
                <?php
                if ($this->Dados['botao']['cad_instituicao']) {
                    echo "<a href='" . URLADM . "cadastrar-instituicao/cad-instituicao' class='btn btn-outline-success btn-sm'>Cadastrar</a> ";
                }
                ?>                
            </div>
        ...
        <?php
        if (empty($this->Dados['dadosInstituicao'])) {
            ?>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover table-bordered table-sm">
                <thead>
                    <tr>
                        <th width="2%">ID</th>
                        <th class="d-none d-sm-table-cell" width="30%">Instituicao</th>
                ...
                <tbody>
                    ...
                    foreach ($this->Dados['dadosInstituicao'] as $es) {
                        extract($es);
                        ?>
                        <tr>
                            <td><?php echo $id_instituicao; ?></td>
                            <td><?php echo '<b class="text-info">' . $nome_instituicao . ' - ' . $sigla_instituicao . ' </b>- <b>INEP:</b> ' . $inep?></td>
                            <td><?php echo '<b>Horário:</b> ' . $horario_instituicao; ?></td>
                            <td><?php
                                if (!empty($logo_instituicao)) {
                                    ...
                                    echo "<img src='" . URLADM . "app/bib/assets/imagens/instituicao/logo_instituicao.png' witdh='120' height='120'>";
                                }
                                ?></td>
                            <td class="text-center">
                                <span class="d-none d-md-block">
                                    ...
                                    if ($this->Dados['botao']['vis_instituicao']) {
                                        echo "<a href='" . URLADM . "ver-instituicao/ver-instituicao/$id_instituicao' class='btn btn-outline-primary btn-sm'>Visualizar</a> ";
                                    }
                                ...
                                <div class="dropdown d-block d-md-none">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                                        <?php
                                        if ($this->Dados['botao']['vis_instituicao']) {
                                            echo "<a class='dropdown-item' href='" . URLADM . "ver-instituicao/ver-instituicao/$id_instituicao'>Visualizar</a>";
                                        }
                                        if ($this->Dados['botao']['edit_instituicao']) {
