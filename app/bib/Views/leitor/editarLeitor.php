            ...
            <div class="col-sm">
                ...
                <div class="form-group col-md-6">
                    ...
                    if (isset($valorForm['foto_leitor']) AND ! empty($valorForm['foto_leitor'])) {
                        $imagem_antiga = URLADM . 'app/bib/assets/imagens/leitor/' . $valorForm['leitor_id'] . '/' . $valorForm['foto_leitor'];
                    } elseif (isset($valorForm['imagem_antiga']) AND ! empty($valorForm['imagem_antiga'])) {
                        $imagem_antiga = URLADM . 'app/bib/assets/imagens/leitor/' . $valorForm['leitor_id'] . '/' . $valorForm['imagem_antiga'];
                    } else {
                        $imagem_antiga = URLADM . 'app/bib/assets/imagens/leitor/foto_leitor.png';
                    }
                    ?>
