                        ...
                        <tr>
                            <td class="text-center">
                                ...
                                if (!empty($foto_leitor)) {
                                    echo "<img src='" . URLADM . "app/bib/assets/imagens/leitor/" . $leitor_id . "/" . $foto_leitor . "' witdh='100' height='100'>";
                                } else {
                                    echo "<img src='" . URLADM . "app/bib/assets/imagens/leitor/icone_leitor.png' witdh='100' height='100'>";
                                }
                                ?>
                            </td>
