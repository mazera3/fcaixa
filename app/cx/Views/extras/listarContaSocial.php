...
foreach ($this->Dados['listSoc'] as $c) {
    extract($c);
}
?>
    ...
    <div class="list-group-item">
        <div class="d-flex">
            ...
            <div class="p-2">
                ...
                if (isset($ano)) {
                    echo "<a href='" . URLADM . "conta-social/listar?ms=$mes_id&an=$ano&soc=$total_social' class='btn btn-outline-danger btn-sm'>Atualizar Conta Social</a> ";
                }
                ?>
            </div>
            <div class="p-2">
                <?php
                echo "<a href='" . URLADM . "conta-social/listar?all=1' class='btn btn-outline-primary btn-sm'>Listar Todos</a> ";
                ?>
            </div>
            <div class="p-2">
                <?php
                if ($this->Dados['botao']['cad_soc']) {
                    echo "<a href='" . URLADM . "cadastrar-conta-social/cad-conta' class='btn btn-outline-success btn-sm'>Cadastrar</a> ";
                }
                ?>
            </div>
        ...
        <div class="table-responsive">
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <?php
                                if ($situacao == 1) {
                                    echo "<a href='" . URLADM . "conta-social/listar?id=$id_soc&pg=0'><span class='badge badge-pill badge-success'>Pago</span></a>";
                                } else {
                                    echo "<a href='" . URLADM . "conta-social/listar?id=$id_soc&pg=1'><span class='badge badge-pill badge-danger'>A Pagar</span></a>";
                                }
                                ?>
                            </td>
                            <td class="text-center">
                                <span class="d-none d-md-block">
                                    <?php
                                    if ($this->Dados['botao']['vis_soc']) {
                                        echo "<a href='" . URLADM . "ver-conta-social/ver-conta/$id_soc' class='btn btn-outline-primary btn-sm'>Visualizar</a> ";
                                    }
                                ...
                                <div class="dropdown d-block d-md-none">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                                        <?php
                                        if ($this->Dados['botao']['vis_soc']) {
                                            echo "<a class='dropdown-item' href='" . URLADM . "ver-conta-social/ver-conta/$id_soc'>Visualizar</a>";
                                        }
                                        if ($this->Dados['botao']['edit_soc']) {
            ...
            <h3><?php if(isset($extenso)){echo 'Total: R$ ' . number_format($total_social, 2, ',', '.') .' (' . $extenso . ')';} ?></h3>
            <?php
