    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Editar Conta Banco</h2>
            </div>
            ...
            ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'ver-conta-banco/ver-conta/' . $valorForm['id_ban']; ?>" class="btn btn-outline-primary btn-sm">Visualizar</a>
                </div>
            <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            <input name="id_ban" type="hidden" value="<?php
            ...
            <input name="EditBan" type="submit" class="btn btn-warning" value="Atualizar">
        </form>
    </div>
</div>
