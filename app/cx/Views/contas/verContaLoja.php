...
if (!empty($this->Dados['dados_loj'][0])) {
    extract($this->Dados['dados_loj'][0]);
    ?>
    <div class="content p-1">
        <div class="list-group-item">
            <div class="d-flex">
                <div class="mr-auto p-2">
                    <h2 class="display-4 titulo">Ver Conta Loja</h2>
                </div>
                <div class="p-2">
                    <span class="d-none d-md-block">
                        <?php
                        if ($this->Dados['botao']['list_loj']) {
                            echo "<a href='" . URLADM . "conta-loja/listar' class='btn btn-outline-info btn-sm'>Listar</a> ";
                        }
                    ...
                    <div class="dropdown d-block d-md-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar"> 
                            <?php
                            if ($this->Dados['botao']['list_loj']) {
                                echo "<a class='dropdown-item' href='" . URLADM . "conta-loja/listar'>Listar</a>";
                            }
                            if ($this->Dados['botao']['edit_loj']) {
            ...
            <dl class="row" style="background-color: #fcfccc;">
                ...
                <dd class="col-sm-9"><?php echo $id_loj; ?></dd>
