    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Cadastrar Conta Energia</h2>
            </div>
            <?php
            if ($this->Dados['botao']['list_ene']) {
            ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'conta-energia/listar'; ?>" class="btn btn-outline-info btn-sm">Listar</a>
                </div>
            <?php
            }
            ?>
        ...
        <div class="row" style="background-color: #cfcfaf;">
            ...
            <input name="CadEne" type="submit" class="btn btn-warning" value="Cadastrar">
        </form>
    </div>
</div>