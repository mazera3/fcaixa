...
if (!empty($this->Dados['dados_inf'][0])) {
    extract($this->Dados['dados_inf'][0]);
    ?>
    <div class="content p-1">
        <div class="list-group-item">
            <div class="d-flex">
                ...
                <div class="p-2">
                    <span class="d-none d-md-block">
                        <?php
                        if ($this->Dados['botao']['list_inf']) {
                            echo "<a href='" . URLADM . "conta-informatica/listar' class='btn btn-outline-info btn-sm'>Listar</a> ";
                        }
                    ...
                    <div class="dropdown d-block d-md-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar"> 
                            <?php
                            if ($this->Dados['botao']['list_inf']) {
                                echo "<a class='dropdown-item' href='" . URLADM . "conta-informatica/listar'>Listar</a>";
                            }
                            if ($this->Dados['botao']['edit_inf']) {
            ...
            <dl class="row" style="background-color: #fcfccc;">
                ...
                <dd class="col-sm-9"><?php echo $id_inf; ?></dd>
