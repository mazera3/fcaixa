    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Listar Conta Energia</h2>
            </div>
            <div class="mr-auto p-2">
            ...
            <div class="p-2">
                ...
                if (isset($ano)) {
                    echo "<a href='" . URLADM . "conta-energia/listar?ms=$mes&an=$ano&ene=$total_energia' class='btn btn-outline-danger btn-sm'>Atualizar Conta Energia</a> ";
                }
                ?>
            </div>
            <div class="p-2">
