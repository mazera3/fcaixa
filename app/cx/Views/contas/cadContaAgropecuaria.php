    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Cadastrar Conta Agropecuaria</h2>
            </div>
            <?php
            if ($this->Dados['botao']['list_agr']) {
            ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'conta-agropecuaria/listar'; ?>" class="btn btn-outline-info btn-sm">Listar</a>
                </div>
            <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <input name="CadAgr" type="submit" class="btn btn-warning" value="Cadastrar">
        </form>
    </div>
</div>