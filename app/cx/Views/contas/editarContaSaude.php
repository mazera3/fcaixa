    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Editar Conta Saude</h2>
            </div>
            ...
            ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'ver-conta-saude/ver-conta/' . $valorForm['id_sau']; ?>" class="btn btn-outline-primary btn-sm">Visualizar</a>
                </div>
            <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            <input name="id_sau" type="hidden" value="<?php
                                                        if (isset($valorForm['id_sau'])) {
                                                            echo $valorForm['id_sau'];
                                                        }
                                                        ?>">
            ...
            <input name="EditSau" type="submit" class="btn btn-warning" value="Atualizar">
        </form>
    </div>
</div>