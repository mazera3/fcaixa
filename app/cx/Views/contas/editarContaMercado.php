    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Editar Conta Mercado</h2>
            </div>
            ...
            ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'ver-conta-mercado/ver-conta/' . $valorForm['id_mer']; ?>" class="btn btn-outline-primary btn-sm">Visualizar</a>
                </div>
            <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            <input name="id_mer" type="hidden" value="<?php
                                                        if (isset($valorForm['id_mer'])) {
                                                            echo $valorForm['id_mer'];
                                                        }
                                                        ?>">
            ...
            <input name="EditMer" type="submit" class="btn btn-warning" value="Atualizar">
        </form>
    </div>
</div>