    ...
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-sm">
                ...
                <div class="form-group">
                    <?php
                    $imagem_antiga = URLADM . 'app/cx/assets/imagens/leitor/preview_img.png';
                    ?>
                    ...
                    <div class="md-modal md-effect-6">
                        <div id="app-panel" class="app-panel md-content row p-0 m-0">     
                            <div id="webcam-container" class="webcam-container col-6 d-none p-0 m-0">
                                ...
                                <div class="flash"></div>
                                <audio id="snapSound" src="<?php echo URLADM . 'app/cx/assets/audio/snap.wav'; ?>" preload="auto"></audio>
                            </div>
