...
/**
 * Description of CxQrCodeLeitor
 *
 * @author mazera
 */
class CxQrCodeLeitor {
    ...
    public function geraQrCode($LeitorId = null, $InstituicaoId = null) {
        ...
        if (!empty($this->Dados['leitor'][0])) {
            ...
            $html .= '<tbody>';
            $html .= '<tr>';
            $html .= '<th class="border text-center"><img src="' . URLADM . "app/cx/assets/imagens/instituicao/" . $id_instituicao . "/" . $logo_instituicao . '" width="10%"></th>';
            ...
            if (!empty($foto_leitor)) {
                $html .= '<td colspan="2" rowspan="2" class="text-center"><img src="' . URLADM . "app/cx/assets/imagens/leitor/" . $leitor_id . "/" . $foto_leitor . '" width="10%"></td>';
            } else {
                $html .= '<td colspan="2" rowspan="2" class="text-center"><img src="' . URLADM . "app/cx/assets/imagens/leitor/icone_leitor.png" . '" width="10%"></td>';
            }
            $html .= '</tr>';
            $html .= '<tr>';
