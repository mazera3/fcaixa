...
/**
 * Description of CxEditarContaConstrucao
 *
 * @copyright (c) year, Édio Mazera
 */
class CxEditarContaConstrucao
{
    ...
    public function verConta($DadosId)
    {
        ...
        $verConta->fullRead("SELECT * FROM cx_conta_construcao
    ...
    private function updateEditConta()
    {
        ...
        $upAltConta->exeUpdate("cx_conta_construcao", $this->Dados, "WHERE id_con =:id_con", "id_con=" . $this->Dados['id_con']);
