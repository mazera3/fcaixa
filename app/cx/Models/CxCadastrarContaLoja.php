...
/**
 * Description of CxCadastrarContaLoja
 *
 * @copyright (c) year, Édio Mazera
 */
class CxCadastrarContaLoja
{
    ...
    private function inserirConta()
    {
        ...
        $cadContaLoja = new \App\adms\Models\helper\AdmsCreate;
        $cadContaLoja->exeCreate("cx_conta_loja", $this->Dados);

        if ($cadContaLoja->getResultado()) {
