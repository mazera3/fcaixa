...
/**
 * Description of CxEditarContaLoja
 *
 * @copyright (c) year, Édio Mazera
 */
class CxEditarContaLoja
{
    ...
    public function verConta($DadosId)
    {
        ...
        $verConta->fullRead("SELECT * FROM cx_conta_loja
    ...
    private function updateEditConta()
    {
        ...
        $upAltConta->exeUpdate("cx_conta_loja", $this->Dados, "WHERE id_loj =:id_loj", "id_loj=" . $this->Dados['id_loj']);
