...
/**
 * Description of CxCadastrarContaEducacao
 *
 * @copyright (c) year, Édio Mazera
 */
class CxCadastrarContaEducacao
{
    ...
    private function inserirConta()
    {
        ...
        $cadContaEducacao = new \App\adms\Models\helper\AdmsCreate;
        $cadContaEducacao->exeCreate("cx_conta_educacao", $this->Dados);

        if ($cadContaEducacao->getResultado()) {
