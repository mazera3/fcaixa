...
/**
 * Description of CxCadastrarContaMecanica
 *
 * @copyright (c) year, Édio Mazera
 */
class CxCadastrarContaMecanica
{
    ...
    private function inserirConta()
    {
        ...
        $cadContaMecanica = new \App\adms\Models\helper\AdmsCreate;
        $cadContaMecanica->exeCreate("cx_conta_mecanica", $this->Dados);

        if ($cadContaMecanica->getResultado()) {
