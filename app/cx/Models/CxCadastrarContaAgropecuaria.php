...
/**
 * Description of CxCadastrarContaAgropecuaria
 *
 * @copyright (c) year, Édio Mazera
 */
class CxCadastrarContaAgropecuaria
{
    ...
    private function inserirConta()
    {
        ...
        $cadContaAgropecuaria = new \App\adms\Models\helper\AdmsCreate;
        $cadContaAgropecuaria->exeCreate("cx_conta_agropecuaria", $this->Dados);

        if ($cadContaAgropecuaria->getResultado()) {
