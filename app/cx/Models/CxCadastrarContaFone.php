...
/**
 * Description of CxCadastrarContaFone
 *
 * @copyright (c) year, Édio Mazera
 */
class CxCadastrarContaFone
{
    ...
    private function inserirConta()
    {
        ...
        $cadContaFone = new \App\adms\Models\helper\AdmsCreate;
        $cadContaFone->exeCreate("cx_conta_fone", $this->Dados);

        if ($cadContaFone->getResultado()) {
