...
/**
 * Description of CxCadastrarContaCombustivel
 *
 * @copyright (c) year, Édio Mazera
 */
class CxCadastrarContaCombustivel
{
    ...
    private function inserirConta()
    {
        ...
        $cadContaCombustivel = new \App\adms\Models\helper\AdmsCreate;
        $cadContaCombustivel->exeCreate("cx_conta_combustivel", $this->Dados);

        if ($cadContaCombustivel->getResultado()) {
