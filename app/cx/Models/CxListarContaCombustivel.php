...
class CxListarContaCombustivel
{
    ...
    public function listarContaCombustivel($PageId = null, $DadosAno = null, $DadosMes = null)
    {
        ...
        $listarContaCombustivel->fullRead("SELECT comb.*, m.mes, m.id_mes FROM cx_conta_combustivel comb
        INNER JOIN cx_mes m ON m.id_mes=comb.mes_id
    ...
    public function atualizar($Valor = null, $DadosAno = null, $DadosMes = null)
    {
        ...
        WHERE dc.descricao LIKE '%' :comb '%' AND ano=:ano AND mes=:mes", "mes={$this->DadosMes}&ano={$this->DadosAno}&comb=Combustivel");
