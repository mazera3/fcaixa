...
/**
 * Description of CxCadastrarContaSaude
 *
 * @copyright (c) year, Édio Mazera
 */
class CxCadastrarContaSaude
{
    ...
    private function inserirConta()
    {
        ...
        $cadContaSaude = new \App\adms\Models\helper\AdmsCreate;
        $cadContaSaude->exeCreate("cx_conta_saude", $this->Dados);

        if ($cadContaSaude->getResultado()) {
