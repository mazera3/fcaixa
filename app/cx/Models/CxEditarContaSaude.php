...
/**
 * Description of CxEditarContaSaude
 *
 * @copyright (c) year, Édio Mazera
 */
class CxEditarContaSaude
{
    ...
    public function verConta($DadosId)
    {
        ...
        $verConta->fullRead("SELECT * FROM cx_conta_saude
    ...
    private function updateEditConta()
    {
        ...
        $upAltConta->exeUpdate("cx_conta_saude", $this->Dados, "WHERE id_sau =:id_sau", "id_sau=" . $this->Dados['id_sau']);
