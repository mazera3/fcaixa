...
/**
 * Description of CxApagarContaInformatica
 *
 * @copyright (c) year, Édio Mazera
 */
class CxApagarContaInformatica
{
    ...
    public function apagarConta($DadosId = null)
    {
        ...
        $apagarConta->exeDelete("cx_conta_informatica", "WHERE id_inf =:id_inf", "id_inf={$this->DadosId}");
