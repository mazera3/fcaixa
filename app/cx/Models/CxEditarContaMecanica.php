...
/**
 * Description of CxEditarContaMecanica
 *
 * @copyright (c) year, Édio Mazera
 */
class CxEditarContaMecanica
{
    ...
    public function verConta($DadosId)
    {
        ...
        $verConta->fullRead("SELECT * FROM cx_conta_mecanica
    ...
    private function updateEditConta()
    {
        ...
        $upAltConta->exeUpdate("cx_conta_mecanica", $this->Dados, "WHERE id_mec =:id_mec", "id_mec=" . $this->Dados['id_mec']);
