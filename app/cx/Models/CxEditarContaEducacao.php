...
/**
 * Description of CxEditarContaEducacao
 *
 * @copyright (c) year, Édio Mazera
 */
class CxEditarContaEducacao
{
    ...
    public function verConta($DadosId)
    {
        ...
        $verConta->fullRead("SELECT * FROM cx_conta_educacao
    ...
    private function updateEditConta()
    {
        ...
        $upAltConta->exeUpdate("cx_conta_educacao", $this->Dados, "WHERE id_edu =:id_edu", "id_edu=" . $this->Dados['id_edu']);
