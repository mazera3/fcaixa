...
/**
 * Description of CxEditarContaInformatica
 *
 * @copyright (c) year, Édio Mazera
 */
class CxEditarContaInformatica
{
    ...
    public function verConta($DadosId)
    {
        ...
        $verConta->fullRead("SELECT * FROM cx_conta_informatica
    ...
    private function updateEditConta()
    {
        ...
        $upAltConta->exeUpdate("cx_conta_informatica", $this->Dados, "WHERE id_inf =:id_inf", "id_inf=" . $this->Dados['id_inf']);
