...
/**
 * Description of CxCadastrarContaEnergia
 *
 * @copyright (c) year, Édio Mazera
 */
class CxCadastrarContaEnergia
{
    ...
    private function inserirConta()
    {
        ...
        $cadContaEnergia = new \App\adms\Models\helper\AdmsCreate;
        $cadContaEnergia->exeCreate("cx_conta_energia", $this->Dados);

        if ($cadContaEnergia->getResultado()) {
