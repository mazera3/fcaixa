...
/**
 * Description of CxEditarContaFone
 *
 * @copyright (c) year, Édio Mazera
 */
class CxEditarContaFone
{
    ...
    public function verConta($DadosId)
    {
        ...
        $verConta->fullRead("SELECT * FROM cx_conta_fone
    ...
    private function updateEditConta()
    {
        ...
        $upAltConta->exeUpdate("cx_conta_fone", $this->Dados, "WHERE id_fon =:id_fon", "id_fon=" . $this->Dados['id_fon']);
