...
/**
 * Description of CxCadastrarContaInformatica
 *
 * @copyright (c) year, Édio Mazera
 */
class CxCadastrarContaInformatica
{
    ...
    private function inserirConta()
    {
        ...
        $cadContaInformatica = new \App\adms\Models\helper\AdmsCreate;
        $cadContaInformatica->exeCreate("cx_conta_informatica", $this->Dados);

        if ($cadContaInformatica->getResultado()) {
