...
/**
 * Description of CxEditarContaCombustivel
 *
 * @copyright (c) year, Édio Mazera
 */
class CxEditarContaCombustivel
{
    ...
    public function verConta($DadosId)
    {
        ...
        $verConta->fullRead("SELECT * FROM cx_conta_combustivel
    ...
    private function updateEditConta()
    {
        ...
        $upAltConta->exeUpdate("cx_conta_combustivel", $this->Dados, "WHERE id_comb =:id_comb", "id_comb=" . $this->Dados['id_comb']);
