...
/**
 * Description of CxEditarContaAgropecuaria
 *
 * @copyright (c) year, Édio Mazera
 */
class CxEditarContaAgropecuaria
{
    ...
    public function verConta($DadosId)
    {
        ...
        $verConta->fullRead("SELECT * FROM cx_conta_agropecuaria
    ...
    private function updateEditConta()
    {
        ...
        $upAltConta->exeUpdate("cx_conta_agropecuaria", $this->Dados, "WHERE id_agr =:id_agr", "id_agr=" . $this->Dados['id_agr']);
